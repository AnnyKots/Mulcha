...
$subject ="Новая заявка с сайта http://127.0.0.1:5500";
...
$header .= "From: Новая заявка <koralist38@gmail.com>\n\n";	
$mail = mail("koralist38@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
